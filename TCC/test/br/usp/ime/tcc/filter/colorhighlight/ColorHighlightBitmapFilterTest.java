...
public class ColorHighlightBitmapFilterTest {
	...
	public void setUp() throws Exception {
		filter = new ColorHighlightBitmapFilter(0, 0, 0, Constants.DEFAULT_TOLERANCE, Constants.DEFAULT_TOLERANCE, Constants.DEFAULT_TOLERANCE);
	}
	...
	public void shouldFilterBitmap() {
		...
		when(bmp.getPixel(anyInt(), anyInt())).thenReturn(Color.BLACK).thenReturn(Color.RED).thenReturn(Color.GREEN).thenReturn(Color.BLUE);
